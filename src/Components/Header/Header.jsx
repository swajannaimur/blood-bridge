...
const Header = () => {
    ...
    const links = (
        <>
            <li><NavLink to="/" className="lg:text-white font-bold transition-transform duration-300 hover:scale-110">Home</NavLink></li>
            <li><NavLink to="/donation-requests" className="lg:text-white font-bold transition-transform duration-300 hover:scale-110">Donation Requests</NavLink></li>
            <li><NavLink to="/all-blogs" className="lg:text-white font-bold transition-transform duration-300 hover:scale-110">Blog</NavLink></li>
        </>
    );
